...
## About
The purpose of this library is to reduce the boilerplate code needed to create react components for css-only frameworks.
Focusing only on the necessary bits.
